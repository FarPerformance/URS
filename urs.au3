...
; PROGRAMS
	...
	Call(FileSort, "(SDK Build)", $Program, $Files[$f])
; COLLECTIONS
	...
	Call(FileSort, "(Mega Man Battle Network Legacy Collection)", $Collection & "\Mega Man Battle Network Legacy Collection", $Files[$f])
	...
	Call(FileSort, "(Retro Collection)", $Collection & "\Retro Collection", $Files[$f])
	Call(FileSort, "(Retro-Bit Generations)", $Collection & "\Retro-Bit Generations", $Files[$f])
	Call(FileSort, "(Retro-Bit)", $Collection & "\Retro-Bit", $Files[$f])
	...
	Call(FileSort, "(FamicomBox)", $Collection & "\FamicomBox", $Files[$f])
	Call(FileSort, "(Menu Cart)", $Collection & "\FamicomBox", $Files[$f])
	Call(FileSort, "(Famicom 3D System)", $Collection & "\Famicom 3D System", $Files[$f])
	...
	Call(FileSort, "(Lock-on)", $Collection & "\Lock-on", $Files[$f])
	Call(FileSort, "(Lock-on Combination)", $Collection & "\Lock-on", $Files[$f])
...
; MAIN REGIONS
	...
	Call(FileSort, "(USA, Europe, Korea)", $Usa, $Files[$f])
	Call(FileSort, "(USA, Asia)", $Usa, $Files[$f])
	...
	Call(FileSort, "(Europe, Asia)", $Europe, $Files[$f])
	Call(FileSort, "(Europe, Australia)", $Europe, $Files[$f])
	Call(FileSort, "(Europe, Brazil)", $Europe, $Files[$f])
	Call(FileSort, "(Europe, Hong Kong)", $Europe, $Files[$f])
	Call(FileSort, "(Europe, Korea)", $Europe, $Files[$f])
...
Func RegionSort($Folder)
    ...
    If IsArray($Files) Then
        ...
        For $f = 1 To $Files[0]
			...
			Call(FileSort, "(France, Spain)", $Folder & "\France", $Files[$f])
